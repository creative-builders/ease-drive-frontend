...
const Register = () => {
  return (
    <div className="h-fit md:h-screen w-full flex flex-col md:flex-row relative">
      <nav className="h-24 w-full flex items-center md:justify-around flex-wrap absolute top-0 z-50">
      ...
      <div className="form h-full w-1/2 bg-gray-300 p-3 md:p-0">
        <main className="h-fit w-full md:w-4/5  bg-white rounded-xl mx-auto mt-24 px-5 py-3 flex flex-col gap-5 items-center justify-around">
          ...
          <p className='text-center'>Enter your name, phone number and email address, and we 'll send 4-digit code to confirm it</p>
            <form action="" className='h-106 w-full flex flex-col items-center justify-around'>
              <div className="input relative h-20 w-full flex items-center justify-between px-2">
              <label className='absolute top-1' htmlFor="">firstname</label>
              <input className='h-12 w-full md:w-211 outline-none bg-gray-200 px-3 mt-5' type="text" id="" />

              <label className='absolute top-1 right-32' htmlFor="">lastname</label>
              <input className='h-39 w-full md:w-211 outline-none bg-gray-200 px-3 mt-5' type="text" id="" />
              </div>
              <label className='translate-x-[-210px]' htmlFor="">Phone Number</label>
              <input className='h-39 w-91 outline-none bg-gray-200 px-3' type="number" id="" />
              <label className='translate-x-[-210px]' htmlFor="">Email address</label>
              <input className='h-39 w-91 outline-none bg-gray-200 px-3' type="email" id="" />
              <button className='h-39 w-91 bg-green-600 text-white cursor-pointer rounded-lg'>Continue</button>
              ...
              <button className='h-39 w-91  bg-gray-300 text-black cursor-pointer rounded-lg relative'><aside className='h-6 w-8 absolute left-24'><img className='object-contain h-full w-full' src={google} alt="" /></aside> Contiue with Google</button>
            </form>
        </main>
      </div>
    </div>

      ...
      <div className="form h-full w-1/2 bg-gray-300 p-3 md:p-0 relative">
        <main className="h-fit w-full md:w-4/5  bg-white rounded-xl mx-auto mt-20 px-5 py-3 flex flex-col gap-4 items-center justify-around">
          ...
          <p className='text-center'>Enter your name, phone number and email address, and we 'll send 4-digit code to confirm it</p>
            <form action="" className='form h-fit w-full flex flex-col items-center justify-around relative gap-2'>
              <div className="input relative h-17 w-full flex items-center justify-between px-2">
              ...
              <label className='translate-x-[-110%] md:translate-x-[-130%]' htmlFor="">Phone Number</label>
              <input className='h-39 w-91 outline-none bg-gray-200 px-3' type="number" id="" />
              <label className='translate-x-[-120%] md:translate-x-[-140%]' htmlFor="">Email address</label>
              <input className='h-39 w-91 outline-none bg-gray-200 px-3' type="email" id="" />
              <button className='h-39 w-91 bg-green-600 text-white cursor-pointer rounded-lg mt-1'>Continue</button>
              ...
              <button className='h-39 w-91  bg-gray-300 text-black cursor-pointer rounded-lg relative'><aside className='translate-x-[-110%] h-5 md:h-6 w-8 absolute left-24'><img className='object-contain h-full w-full' src={google} alt="" /></aside> Contiue with Google</button>
            </form>
        </main>
      </div>
    </div>

    ...
    return (
        <div className='min-h-screen bg-gray-500 w-full flex flex-col items-center gap-5'>
            ...
            <p className="flex text-center gap-3 text-sm">
                <Link to="/DriVerify"><span className="text-xs lg:text-base">Identity Verification</span></Link>
                <Link to="/DrivUpload"><span className="text-xs lg:text-base">Address Verification</span></Link>
            </p>

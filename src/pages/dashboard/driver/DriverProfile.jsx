    ...
    <>
      ...
      <div className="bg-white rounded-2xl p-6 shadow-md gap-4 flex flex-col">
        ...
        <section className="gap-2 p-2 relative border-b border-[#E7E7E7]">
          ...
          <InputField
            leftIcon={CarIcon}
            value={userData?.vehicleModel || vehicleType || "---"}
          ...
          <InputField
            leftIcon={ColorIcon}
            value={userData?.vehicleColor || vehicleColor || "---"}
            placeholder={"Black"}
            inputWrapperStyles={"border-none"}
            readOnly
          />
          ...
          <InputField
            ...
            value={userData?.plateNumber || plateNumber || "---"}
            placeholder={"ABC123"}
            inputWrapperStyles={"border-none"}
            readOnly
          />
          ...
          <InputField
            ...
            value={userData?.documentId || documentID || "---"}

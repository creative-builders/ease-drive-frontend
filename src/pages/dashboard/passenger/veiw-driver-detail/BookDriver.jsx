...
export const BookDriver = ({ driver, onBack }) => {
  ...
  return (
    <motion.div
      ...
      className="bg-white rounded-lg shadow-none lg:shadow-md w-full md:w-[557px] absolute top-12 flex flex-col gap-4 px-4 py-3"
    >
      <button
        onClick={onBack}
      ...
      <CustomButton
       ...
       extendedStyles="mt-52 md:mt-6 w-full mb-2 bg-green-700 text-white px-4 py-4 gap-2 text-lg rounded-2xl hover:bg-green-700 transition"

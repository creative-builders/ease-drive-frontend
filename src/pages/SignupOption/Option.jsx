...
export default function Option() {
  ...
  return (
    ...
    <div className="h-screen w-full flex flex-col items-center justify-evenly relative">
        ...
        <nav className="h-[100px] w-full flex items-center justify-around absolute top-0 border-b-2">
        ...
        <div className="box h-full w-full flex items-center justify-between">
          ...
          <div className="form h-full w-[650px]">
            <main className="h-[450px] w-[90%] mx-auto mt-[200px] px-5 py-3 flex flex-col gap-5 items-center justify-around">
              <p>Sign up as a</p>

              {/* Passenger Section */}
              <section
                className={`h-[100px] w-4/5 relative border px-2 py-3 flex flex-col gap-2 rounded-lg cursor-pointer ${
              ...
              >
                ...
                <i className="pin absolute text-[16px] right-1 top-12 fa fa-angle-right" aria-hidden="true"></i>
              </section>

              <section
                className={`h-[120px] w-4/5 relative border px-2 py-3 flex flex-col gap-2 rounded-lg cursor-pointer text-sm ${
              ...
              <button
                className="h-[50px] w-4/5 rounded-md bg-green-600 text-white disabled:bg-gray-400"

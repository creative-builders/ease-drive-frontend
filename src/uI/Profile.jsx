...
const Profile = () => {
  ...
  return (
    <div className="gap-5 items-center justify-center md:p-10 md:bg-[#f2f5f6] relative">
        <h2 className="font-[inter] font-semibold md:font-bold text-[14px] md:text-[24px] leading-6 md:leading-[100%] tracking-normal text-left ml-5 md:ml-0 mt-5 md:mt-0">Profile</h2>
      {/* Profile View */}

                    ...
                    <div className="w-4/5 h-full text-sm flex flex-col gap-12">
                        ...
                        <div className='w-full h-3/4 text-sm flex flex-col gap-8'>
                            ...
                            <div className="flex w-full items-center gap-10">
                                ...
                                <p className="font-normal xl:font-medium text-[14px] xl:text-base not-italic">{name}</p>
                                <p className="font-normal xl:font-medium text-[14px] xl:text-base not-italic">{distance}</p>
                                <p className="font-normal xl:font-medium text-[14px] xl:text-base not-italic">{rating}</p>
                                <p className="font-normal xl:font-medium text-xs text-[#B8B8B8] not-italic gap-6">{vehicleInfo}</p>
                                </section>
                            </div>

...
const GoogleAuthV3 = ({ role = "passenger" }) => {
  ...
  return (
    <>
      {loading ? (
        <CustomButton extendedStyles="inline-block mb-8 w-full px-1.5 rounded-lg" isLoading={loading} />
      ) : (
        <button
          onClick={(e) => {
            e.preventDefault();
          ...
          className="inline-block border border-neutral-400 mb-16 w-full p-4 bg-gray-300 rounded-lg"
        >

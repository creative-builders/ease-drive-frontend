    ...
    return (
        <div className="flex items-center lg:justify-between justify-center gap-16 lg:mt-4 mb-8">
            ...
            <div className="flex items-center lg:gap-2 gap-1">
                <span className="lg:text-sm text-[8px] text-gray-600">Page</span>
                <div className="relative inline-block">
                    <select
                        value={currentPage}
                        onChange={(e) => onPageChange(Number(e.target.value))}
                        className="px-2 py-1 pr-6 rounded-md border lg:text-sm text-[8px] appearance-none"
                    >
                ...
                <span className="ml-2 lg:text-sm text-[8px] text-gray-600">of {totalPages}</span>
            </div>

            {/* Pagination controls */}
            <div className="flex items-center lg:gap-2 gap-1 lg:text-sm text-[8px]">
                <button

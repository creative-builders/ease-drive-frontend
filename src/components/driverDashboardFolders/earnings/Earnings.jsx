            ...
            <div className="inline-flex justify-start items-start ">
                <div className="lg:w-[563px] w-[100%] m-auto font-poppins inline-flex flex-col lg:justify-start lg:items-start gap-4">
                    <div className='flex lg:gap-2 gap-3'>
                        <InfoCard title="Current Balance" InfoIcon={EarningsIcon} value={"5,200"} footer={{text:"Earnings this month", value:"5"} } />
                        <InfoCard title="Total Earnings" InfoIcon={EarningsIcon} value={"85,200"} footer={{text:"Since account activation", value:"8" }}/>
                    </div>

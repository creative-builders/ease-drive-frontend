...
export const RideRequestDetails = ({ request }) => {
    ...
    return (
     <div className="self-stretch px-5 py-3 pb-4 bg-white rounded-lg
      inline-flex flex-col lg:w-[560px] w-[360px]  lg:justify-start justify-center lg:items-start gap-2 relative">
                ...
                {modalType === "amount" && (
                    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
                        ...
                        top-[35%] h-[229px] lg:w-[633px] lg:h-[249.5px]">
                            {/* Close Button */}
                            <button
                                onClick={() => setModalType(null)}
                                className="absolute top-2 right-2 text-black"
                ...
                {modalType === "success" && (
                    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
                        <div className="relative bg-white rounded-3xl p-6 flex flex-col gap-4 w-[390px] lg:top-[] 
                        top-[28%] h-[331px] lg:w-[633px] lg:h-[249.5px] justify-center items-center">

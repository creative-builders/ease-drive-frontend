...
export const RideRequestDetails = ({request}) => {
    const { name, avatar, eta, currentLocation, onAccept, onBack, destination, fare, rideType, status, date, pickup, luggage, time } = request;
  return (
    ...
    <div className="self-stretch h-11 inline-flex justify-start items-center">
        <div className="w-10 h-10 px-1 py-[3px] bg-white rounded-[32px] flex justify-center items-center gap-1 overflow-hidden">
            <div className="w-6 h-6 relative">
                <BiArrowBack onClick={onBack} className="w-6 h-6 text-black" />
            </div>
        </div>
    ...
    <div className="self-stretch flex flex-col justify-start items-center gap-12">
        <div className="self-stretch flex flex-col justify-start items-center gap-11">
            <div className="self-stretch flex flex-col justify-start items-center gap-4">
                <div className="flex flex-col justify-start items-center gap-1">
                    <img className="w-24 h-24 relative rounded-[50px]" src={avatar} />
                    <div className="justify-start text-black text-base font-semibold font-['Inter']">{name}</div>
                </div>
                <div className="self-stretch flex flex-col justify-start items-start gap-2">
                    ...
                    <div className="self-stretch flex flex-col justify-start items-start gap-4">
                        <div className="self-stretch inline-flex justify-between items-start gap-14">
                            ...
                            <div className="w-56 text-right justify-end text-black text-base font-normal font-['Inter']">{time}, {date}</div>
                        </div>
                        <div className="self-stretch inline-flex justify-between items-start gap-14">
                            <div className="justify-start text-black text-base font-semibold font-['Inter']">Pick Up location</div>
                            <div className="text-right justify-end text-black text-base font-normal font-['Inter']">{pickup}</div>
                        </div>
                        <div className="self-stretch inline-flex justify-between items-start gap-14">
                            <div className="w-28 justify-start text-left text-black text-base font-semibold font-['Inter']">Destination</div>
                            <div className="text-right justify-end text-black text-base font-normal font-['Inter']">{destination}</div>
                        </div>
                        <div className="self-stretch inline-flex justify-between items-center gap-14">
                            ...
                            <div className="w-56 text-right justify-end text-black text-base font-normal font-['Inter']">{rideType}</div>
                        </div>
                        <div className="self-stretch inline-flex justify-between items-start gap-14">
                            <div className="w-28 justify-start text-black text-base font-semibold font-['Inter']">Luggage</div>
                            <div className="w-56 text-right justify-end text-black text-base font-normal font-['Inter']">
                               {
                                luggage && luggage.length > 0 ? "Yes" : "No"
                               } 
                            ...
                            <div className="inline-flex justify-start items-center gap-1">
                                {luggage && luggage.length > 0 ? (
                                  luggage.map((img, index) => (
                                    <img key={index} className="w-24 h-24 rounded" src={img} alt={`Luggage ${index + 1}`} />
                                  ))
                                ) : (
                                  <div className="text-neutral-500">No luggage images available</div>
                                )}
        ...
        <div className="self-stretch inline-flex justify-start items-start gap-4">
            <div className="flex-1 h-14 px-4 bg-Primary-700 rounded-2xl flex justify-center items-center gap-2 overflow-hidden">
                <CustomButton name="Accept Ride and Enter Amount" btnClick={onAccept}  extendedStyles="w-full p-3 lg:p-4 rounded-lg"/>
